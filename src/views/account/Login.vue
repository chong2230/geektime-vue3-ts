...
import accountData from '@/mock/account/index'
...
export default {
    ...
    setup() {
        ...
        async function getCellphoneList() {
            ...
            */
           let list: any = accountData['/account/cellphone/list'].data;
           state.cellphoneList = list;
        }

        const showCountryCode = (bool: boolean) => {
            state.showCellPhone = bool ? bool : !state.showCellPhone;
        }

        const chooseCountryCode = (item: any) => {
            console.log(item);
